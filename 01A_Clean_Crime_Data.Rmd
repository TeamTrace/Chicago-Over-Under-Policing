---
title: Prepare Chicago Crime Data
output:
  html_document:
    fig_caption: yes
    fig_height: 4
...
This notebook formats Chicago Police Department crime data for analysis, combining data from multiple sources.
...
For incidents prior to 2013, we checked to see if online data uses the depreciated district or the present day districts. It looks like the depreciated districts are not in the data at all, implying that the data uses the present-day district where the incident occurred.

- 13th closed, merged into the 12th. 
- 21st closed and was split between the 1st and 2nd district, with a small piece going to the 9th.
- 23rd closed on March 4 of 2012, and merged with the 19th.
